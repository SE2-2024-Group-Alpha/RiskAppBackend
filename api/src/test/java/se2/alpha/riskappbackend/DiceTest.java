...
public class DiceTest {
    ...
    public void testRoll() {
        IntStream.range(0, 1000).forEach(i -> {
            ...
            Assertions.assertTrue(result >= 1 && result <= dice.getNumSides(), "Roll should be between 1 and " + dice.getNumSides());
        });
    }
    ...
    public void testRollMultipleTimesValues() {
        ...
        for (int result : results) {
            Assertions.assertTrue(result >= 1 && result <=dice.getNumSides(), "Each roll should be between 1 and " + dice.getNumSides());
        }
    }
    ...
    public void testRollMultipleTimesNotNull() {
        ...
        Assertions.assertTrue(Arrays.stream(results).noneMatch(r -> r < 1 || r > dice.getNumSides()), "All roll results should be between 1 and " + dice.getNumSides());
    }
    ...
    public void testRollMultipleTimesSum() {
        ...
        Assertions.assertTrue(sum >= minSum && sum <= maxSum, "The sum of all rolls should be within the expected range");
    }
